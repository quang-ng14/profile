...
namespace WebApi1.Controllers
{
    ...
    public class LoginController : Controller
    {
        ...
        public IActionResult Login([FromBody]LoginInfo info)
        {
            ...
            var check = _context.LoginInfos.FirstOrDefault(i => i.Username == info.Username);
            if (check != null)
            loginStatus.IsSuccess = (check.Password == info.Password);
            else loginStatus.IsSuccess = false;
